...
volatile uint16_t g_oled_transfer_page = 0U;
volatile uint16_t g_oled_transfer_offset = 0U;
volatile uint16_t g_oled_transfer_chunk_length = 0U;
volatile uint32_t g_oled_transfer_chunk_ok_count = 0U;
volatile uint32_t g_oled_transfer_chunk_error_count = 0U;
...
gmp_task_status_t tsk_startup(gmp_task_t* tsk)
{
    ...
    g_oled_transfer_chunk_ok_count = 0U;
    g_oled_transfer_chunk_error_count = 0U;
