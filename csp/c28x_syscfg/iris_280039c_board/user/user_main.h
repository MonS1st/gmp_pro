...
extern volatile uint16_t g_oled_transfer_page;
extern volatile uint16_t g_oled_transfer_offset;
extern volatile uint16_t g_oled_transfer_chunk_length;
extern volatile uint32_t g_oled_transfer_chunk_ok_count;
extern volatile uint32_t g_oled_transfer_chunk_error_count;
