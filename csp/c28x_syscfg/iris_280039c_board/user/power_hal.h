...
// Active-high OVP/OCP fault output: ePWM4A on GPIO22.
extern volatile uint16_t g_epwm_fault_command;
extern volatile uint16_t g_epwm_fault_level;
extern volatile uint32_t g_epwm_fault_assert_count;
extern volatile uint32_t g_epwm_fault_clear_count;
