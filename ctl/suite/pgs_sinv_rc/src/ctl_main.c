...
void ctl_init(void)
{
    ...
    ctl_init_2023a_voltage_loop(&voltage_loop_2023a,
        SINV_2023A_UO_REF_RMS_V, CTRL_VOLTAGE_BASE, CTRL_CURRENT_BASE,
        ...
        SINV_2023A_LOAD_CURRENT_FF_GAIN,
        SINV_2023A_CAP_CURRENT_FF_GAIN,
        (fast_gt)SINV_2023A_ENABLE_LOAD_CURRENT_FF,
        (fast_gt)SINV_2023A_ENABLE_CAP_CURRENT_FF,
        CONTROLLER_FREQUENCY);
#else
